...
<html lang="en">
<head>
  <title>hitung jumlah barang berdasarkan Kondisi</title>
</head>
<!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-5">
        <h3>
          ...
          Report Data Jumlah Barang Berdasarkan Kondisi
         </h3><hr>  
...
<tr>
  <th scope="col"><p align="center">Kondisi</p></th>
...
<tbody>
<?php
  $kondisi = mysqli_query($koneksi, "SELECT * FROM kondisi LEFT JOIN hitungkondisi ON kondisi.IDkondisi = hitungkondisi.IDkondisi");
  foreach ($kondisi as $row):
  ?>
  <tr>
    <th scope="row"> <?= $row['namakondisi']; ?></th>
    <td><?= $row['jumlah']; ?></td>
  </tr>
