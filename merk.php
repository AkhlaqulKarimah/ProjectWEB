...
if(!$_SESSION['username']) {
  ...
  $result = mysqli_query($koneksi, "SELECT * FROM merk ORDER BY IDmerk ASC");
?>
...
<br/>
    ...
    <a href="addmerk.php" class="btn  btn-primary mb-2"><i class="fas fa-plus-square mr-4"></i>
        TAMBAH DATA MERK</a>
      </div>
      <div class=" d-flex justify-content-end">
    <a style="margin-top: -33px"  href="merkcetakprint.php" target="_blank" class=" btn  btn-primary mb-2"> CETAK PRINT </a>
    </div>
    <a class="d-flex justify-content-end" target="_blank" href="export_excelmerk.php">EXPORT KE EXCEL</a>
...
<table class="table table-striped table-bordered">			
	...
	<input type='submit' value='cari'><a href='merk.php' >&nbsp  All</a>
	<br/><br/>
</form>
...
while($rows=mysqli_fetch_object($result)){
        ...
        <td><?php   echo $rows -> kodemerk;?></td>

        <td><a href = 'editmerk.php?id=<?php echo $rows-> IDmerk;?>'>
        <i class="fas fa-edit bg-success p-2 text-white rounded" data-toggle="tooltip" title="Edit"></i></a></td>

        <td><a href = 'hapusmerk.php?id=<?php echo $rows-> IDmerk;?>'>
