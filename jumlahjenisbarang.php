...
<html lang="en">
<head>
  <title>hitung jumlah barang berdasarkan jenis barang</title>
</head>
<!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-5">
        <h3>
          ...
          Report Data Jumlah Barang Berdasarkan Jenis Barang
         </h3><hr>  
...
<tr>
  <th scope="col"><p align="center">JenisBarang</p></th>
...
<?php
  $jenisbarang = mysqli_query($koneksi, "SELECT * FROM jenisbarang
    LEFT JOIN hitungjenisbarang ON jenisbarang.IDjenisbarang = hitungjenisbarang.IDjenisbarang");
  foreach ($jenisbarang as $row):
  ?>
  <tr>
    <th scope="row"> <?= $row['namajenisbarang']; ?></th>
    <td><?= $row['jumlah']; ?></td>
  </tr>
